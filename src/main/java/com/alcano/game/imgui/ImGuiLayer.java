package com.alcano.game.imgui;

import com.alcano.game.core.Window;
import com.alcano.game.level.Scene;
...
public class ImGuiLayer {
    ...
    public void initImGui() {
        ...
        fontAtlas.addFontFromFileTTF("assets/fonts/roboto_light.ttf", 24, fontConfig);
    ...
    public void update(Scene currentScene) {
        this.startFrame(Time.deltaTime);
    ...
    private void startFrame(final float deltaTime) {
        ...
        double[] mousePosX = {0.0D};
        double[] mousePosY = {0.0D};
